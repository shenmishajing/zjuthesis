...
\documentclass[
    ...
    % Thesis Info
    StudentName     = 郑文浩,
    StudentID       = 3170105369,
    AdvisorName     = 吴健,
    Grade           = 2017,            % only the year, no '级'
    Major           = 计算机科学与技术,
    Department      = 计算机科学与技术学院,
    SubmitDate      = 2021年6月2日,
    MajorFormat     = cs,
    ...
    % Title
    Title           = 基于半监督学习和任务分解的宫颈病变细胞检测,
    TitleEng        = Detection of cervical lesion based on semi-supervised learning and task decomposition
]{zjuthesis}
